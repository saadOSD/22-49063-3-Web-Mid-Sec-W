...
$dashboardLink = ($_SESSION['role'] === 'admin') ? "admindashboard.php" : "doctordashboard.php";
?>
...
<body>
                ...
                <div class="form-group">
                    <?php if ($edit_state): ?>
                        ...
                        <a href="Organ_Donation.php"
                            style="display:block; text-align:center; margin-top:5px; color: #333;">Cancel</a>
                    <?php else: ?>
    ...
    <script>
        // ব্লাড কম্প্যাটিবিলিটি রুলস (Medical Logic)
        ...
        findMatchBtn.addEventListener('click', function () {
            ...
            rows.forEach(row => {
                ...
                if (recOrgan === donorOrgan) {
                    // ব্লাড গ্রুপ মিলতে হবে (রুলস অনুযায়ী)
